  ...
  return (
    ...
    >
      ...
      <Grid maxW={pxToRem(359)} templateRows="1fr 0.73fr 1fr">
        ...
        Estamos muito felizes em ter você aqui no site da Contemp. Veja nossa nova linha de produtos, a funcionalidade do NFC e as especificações técnicas para aplicações em seus processos.
        </Text>
        {isMobile ? (
