...
const Variation = ({ index, addVariation, defaultValues, newVariation, removeVariation }: any) => {
            ...
            <Flex alignItems="center" justifyContent="space-between" w="100%">
                <Flex alignItems="center">
                    <Box w="400px">
                        ...
                        <InputDefault
                            ...
                            type="text"
                            error={errors.addOpt}
                            {...register("addOpt", { required: "Nome da opção é obrigatório" })}
                        />
                    </Box>
                    <Icon
                        as={GrAddCircle}
                ...
                <Box w="100%" ml="30px">
                    ...
                    >
                        ...
                        >
                            {defaultValues.opt && defaultValues.opt.map((value: any) => (
