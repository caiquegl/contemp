...
export default function handler(req: any, res: any) {
  ...
  const directoryPath = process.env.STATUS === 'HMG' ? '/var/www/html/manuais_hmg' : '/var/www/html/manuais';
...
function getContentType(fileExtension: string): string {
  switch (fileExtension) {
    ...
    case '.pptx':
      return 'application/vnd.openxmlformats-officedocument.presentationml.presentation'; // PowerPoint
    case '.docx':
