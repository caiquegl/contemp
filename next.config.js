...
module.exports = {
  ...
  async redirects() {
    ...
    //GOOGLE ADS
      ...
      creatRedirectObj ('/categoria-produto/controladores-de-potencia', '/category/controladores_de_potencia'),
      creatRedirectObj ('/produtos/termovisores-flir-portateis-e-fixos/portateis/----termometro-ir-flir-tg165', '/category/pirometros_infravermelhos_fixos'),
      creatRedirectObj ('/categoria-produto/controlador-de-potencia-e-reles-de-estado-solido', '/category/controladores_de_potencia'),
